...
// EntryMotion takes over. 否则 /room 内容 一闪 then 被 overlay cover (owner
    ...
    >
      <head>
        {/* Inline bg style — 浏览器第一帧 paint 之前就 apply, 避开
            globals.css fetch + parse 期间 默认 white 闪 (owner 260517 0043
        ...
        {/* Preload critical fonts BEFORE fonts.css fetch — 避开 first-paint
            用 fallback 字体, woff2 load 完后 swap reflow 闪 (owner 260517 0055
        ...
        {/* iOS PWA splash · 纯 #0c0c0c 黑底 PNG (no image, just dark bg).
            ...
            (owner 260517 0039 catch). 仅作 bg 填充, EntryMotion React-level
